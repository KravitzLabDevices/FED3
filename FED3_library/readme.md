## This is the FED3 library, version 0.0.1 (beta)
...
1. Download the supporting libraries for FED3: [FED3_supporting_libraries.zip](https://github.com/KravitzLabDevices/FED3/blob/master/FED3_library/FED3_support_libraries.zip). Unzip the contents of this file to your Arduino libraries folder (usually this is: Documents\Arduino\libraries). 
